...
describe("longest", function() {
  it("returns the length of the longest word in an array of words", function() {
    ...
    expect(longest(["hola", "hello", "hi"])).toBe(5);
    expect(longest(["hola", "hello", "hi", "banana"])).toBe(6);
    expect(longest(["holaaaaa", "hello", "hi", "banana"])).toBe(8);
  });
});
...
describe("find", function() {
  ...
  it("returns true if the value exists", function() {
    expect(find(["duck", "cat", "pony"], "duck")).toBe(true);
    expect(find(["duck", "cat", "pony"], "cat")).toBe(true);
    expect(find(["duck", "cat", "pony"], "pony")).toBe(true);
  });

  it("returns false if value does not exist", function() {
    expect(find(["duck", "cat", "pony"], "porcupine")).toBe(false);
  });
});
...
describe("binarySearch", function () {
  it("should find true/false in a sorted array", function() {
